...
HD_PWD='C:/EOS/EOS_HDMI-UDP_Game/Ex2_Src/BlockDesign_HDMI_With-filter/PogingZes/HdmiPogingDrie/HdmiPogingDrie.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
