...
HD_PWD='c:/eos/eos_hdmi-udp_game/ex2_src/colorfilterv3/ip_repo/edit_eFPGA_FILTER_Core1_v2_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_FILTER_Core1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eFPGA_FILTER_Core1.tcl -notrace
