...
HD_PWD='c:/eos/eos_hdmi-udp_game/ex2_src/colorfilterv3/ip_repo/edit_eFPGA_FILTER_Core1_v2_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_FILTER_Core1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eFPGA_FILTER_Core1.tcl
