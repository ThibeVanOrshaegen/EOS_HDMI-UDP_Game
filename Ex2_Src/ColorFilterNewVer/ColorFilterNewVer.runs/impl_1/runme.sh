...
HD_PWD='C:/EOS/EOS_HDMI-UDP_Game/Ex2_Src/ColorFilterNewVer/ColorFilterNewVer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ColorFilter_axi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ColorFilter_axi.tcl -notrace
