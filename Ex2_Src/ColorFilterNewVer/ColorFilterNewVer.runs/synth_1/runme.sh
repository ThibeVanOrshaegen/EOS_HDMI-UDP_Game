...
HD_PWD='C:/EOS/EOS_HDMI-UDP_Game/Ex2_Src/ColorFilterNewVer/ColorFilterNewVer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ColorFilter_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ColorFilter_axi.tcl
